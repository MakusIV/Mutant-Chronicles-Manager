        ...
        "effetti": [
            {
                ...
                "valore": "",
                "statistica_target": "",
                "descrizione_effetto": "Può solo essere assegnato agli Eretici. Gli avversari dell'Eretico sono accecati e in combattimento non possono rispondere. L'Eretico colpisce sempre per primo nel combattimento e, dopo che l'Eretico ha attaccato il suo avversario, il combattimento ha termine.",
                "condizioni": ["Solo Eretici"],
                "limitazioni": ["L'avversario non può rispondere all'attacco"],
                "effetti_collaterali": ["Il combattimento termina subito dopo l'attacco dell'Eretico"]
            }
        ],
        "testo_carta": "DONO DELL'OSCURA SIMMETRIA. PUÒ SOLO ESSERE ASSEGNATO AGLI ERETICI. Gli avversari dell'Eretico sono accecati e in combattimento non possono rispondere. L'Eretico colpisce sempre per primo nel combattimento e, dopo che l'Eretico ha attaccato il suo avversario, il combattimento ha termine.",
        "flavour_text": "",
        "keywords": ["Eretico"],
        "stato_gioco": {
            "in_gioco": False,
